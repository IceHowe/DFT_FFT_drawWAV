...
public class Demo {
	...
	public static void main(String[] args) {
		playAndDraw();
//		drawSpectrogram("Honor.wav");//绘制歌曲“荣耀”频谱图
//		drawWaveFile("Honor.wav");//绘制歌曲“荣耀”波形图
//		drawSpectrogram("wav_40_16_2_pcm.wav");//绘制歌曲频谱图
//		drawWaveFile("wav_40_16_2_pcm.wav");//绘制歌曲波形图
//		drawSpectrogram("TEST.wav");//绘制歌曲频谱图
//		drawWaveFile("TEST.wav");//绘制歌曲波形图
	...
	public static void playAndDraw() {
		...
		Thread t2 = new FFTCalc0ToEnd("Honor.wav");//绘制频谱
//		Thread t3 = new WavDraw("Honor.wav");//绘制波形
		t1.start();//开启播放音乐线程
		t2.start();//开启绘制频谱线程
//		t3.start();//开启绘制波形线程
	}
